...
class RecommenderSystem(object):
    ...
    def recommend_movies(self, movie, number_of_movies=10):
        ...
        # print("\n====================================================================")   
        # print(f"ITEM BASED Recommended movies based are:") 
        # print("====================================================================\n") 
        # for movie in combined_list:
        #     print(movie)
        # print("\n--=-=-=-=-=-=-=-=-==-MOVIE_POSTERS--=-=-=-=-=-=-=-=-==-\n")
        # poster_fetch.movie_poster_fetch(combined_list)
        print("Started ITEM with movie: ",movie)
        titles=[]
        for movie in combined_list:
        ...
        movie_dict = {"movie_ls_finale": combined_list, "titles_id": movie_id_ls}
