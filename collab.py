...
class collabrative_filtering:
    ...
    def recommend_movies(self):
        ...
        if bool(close_match):
            ...
            final_list=[]
            print(f"People who watched {self.user_fav_movie} also liked these movies give them a try:\n")
            for i in range(1,11):
                row = final.index[i]
            ...
            print(f"\nPeople who watched {self.user_fav_movie} also liked these movies give them a try:")
...
crc = collabrative_filtering("huge_cmovies_dataset.csv")
